...
export const userInsertQuery = (email, password) => ({
    name: "insert-user",
...
export const getDataQuery = (table) => ({
    name: "table",
    text: `SELECT * FROM ${table}`,
});
export const getDataFleetQuery = (table) => ({
    name: "table",
    text: `SELECT id, ac_name as "name", ac_type as "acType", ac_reg as "acReg", ac_seats as "seats" FROM ${table}`,
});
export const getDataFlightsQuery = (table, date) => ({
    name: "flights",
...
export const deleteDataQuery = (table, id) => ({
    name: "delete-data",
...
export const userUpdateProfileQuery = ({ id, firstname, lastname, phone, cn, }) => ({
